export const siteConfig = {
  ...
  about: [
    "我是一名 Agent / AI 应用工程师，武汉大学软件工程在读。我曾在影石 Insta360 剪辑 SDK 组实习，关注的不只是把模型接进产品，更是 Context 如何选择、工具如何约束、失败如何降级，以及用户为什么愿意长期使用。",
    "客户端与系统工程是我的底座。做过跨端剪辑、播放器 Seek、macOS 终端和端侧语音，这些经历让我习惯用异步契约、预算、幂等、可观测性和测试去约束不确定性——现在也用同样的方法做 Agent。",
    "代码之外，我是视觉中国签约摄影师，也在短视频里分享技术与成长，积累了 3000+ 关注者。我喜欢把复杂系统讲清楚，也在意产品被看见、被理解时的质感。",
  ],
  capabilityGroups: [
    {
